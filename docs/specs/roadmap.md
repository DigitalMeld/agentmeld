...
5. WhatsApp integration; compare Linq, BlueBubbles, imsg and other providers only when this milestone begins. Add Windows, general remote-browser access, additional connectivity options (including evaluation of Tailscale), dictation, read-aloud, voice and push as separately qualified increments.
