...
3. Controlled dedicated-VM recovery now passes. Qualify remaining session lifecycle cases with dedicated fixtures that preserve the owner session. Record viewer selection and the supported test envelope before M0 sign-off.
